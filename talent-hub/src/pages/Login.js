...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch('httphttps://talenthub-w1cc.onrender.coms://talenthub-w1cc.onrender.com/api/auth/login', {
        method:  'POST',
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    try {
      const res = await fetch('httphttps://talenthub-w1cc.onrender.coms://talenthub-w1cc.onrender.com/api/auth/google', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
